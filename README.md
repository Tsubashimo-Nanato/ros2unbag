...
Release preparation date: 2026-07-10

This project has been publicly released and is currently maintained at version `1.6.1`. The core workflow is usable in real offline bag-inspection and export workflows, while some features remain incomplete and edge cases may still exist.
...
```powershell
ros2unbag upgrade --ref v1.6.1 --yes
```
